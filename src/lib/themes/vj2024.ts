...
const vj2024base: LayoutTheme = {
  ...
  style: `
    ...
    --background: var(--background-color) url('/images/paivaleiska.png') repeat fixed top left;
    --background-2: var(--background-color-2) url('/images/paivaleiska.png') repeat fixed top left;
